...
CLASS z_create_csv_structure IMPLEMENTATION.
    ...
    METHOD insert_data.
      ...
      DATA lt_data TYPE TABLE OF zorders_table.
      DATA ls_data TYPE zorders_table.
      ...
      ls_data-order_date = '2017-08-11'.
      ls_data-ship_date = '2017-11-11'.
      ...
      ls_data-order_date = '2017-08-12'.
      ls_data-ship_date = '2017-11-12'.
      ...
      ls_data-order_date = '2017-08-13'.
      ls_data-ship_date = '2017-11-13'.
      ls_data-ship_mode = 'Second Class'.
      ...
      MODIFY zorders_table FROM TABLE @lt_data.
